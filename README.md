...
Schema Design: Translated the ERD into a physical database schema with 8 relational tables. 
...
Advanced Constraints: Implemented CHECK constraints and Regular Expressions (REGEXP) for data validation (e.g., verifying phone formats and email structures). 
